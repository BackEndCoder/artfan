        ...
        <div class="wrapper">
            <header>
                ...
                <div class="header-right">
                    <ul class="header-cart">
                        <li><a href="<?php echo $this->base;?>/ProductDetails/cart">View Cart</a></li>
                        <li><a href="<?php echo $this->base;?>/ProductDetails/cart"><img src="<?php echo $this->base; ?>/img/shopping-cart.png" width="20" height="16" alt="shopping cart" /></a></li>
            ...
            <nav>
                <ul class="menu">
                    ...
                    <li><?php echo $this->Html->link('All Art', array('controller' => 'Products', 'action' => 'all')); ?></li>
                    <li><?php echo $this->Html->link('Artists', array('controller' => 'Artists', 'action' => 'lists')); ?></li>
                    <li><?php echo $this->Html->link('Be Inspired', array('controller' => 'Pages', 'action' => 'show', 1)); ?></li>
                    <li><?php echo $this->Html->link('Gift Vouchers', array('controller' => 'Pages', 'action' => 'show', 2)); ?></li>
					<li><?php echo $this->Html->link('Wishlist', array('controller' => 'Wishlists', 'action' => 'index')); ?></li>
                    <li><?php echo $this->Html->link('Get in Touch', array('controller' => 'Pages', 'action' => 'show', 3)); ?></li>
                </ul>
                <div class="signup">
                    <ul>
