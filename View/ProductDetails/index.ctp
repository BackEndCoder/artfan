<?php
    $this->Html->addCrumb($product['Category']['catname'], '/ProductDetails/category/'. $product['Category']['id']);
    $this->Html->addCrumb($product['Color']['colorname'], '/ProductDetails/color/' . $product['Color']['id']);
    $this->Html->addCrumb($product['Style']['stylename'], '/ProductDetails/style/' . $product['Style']['id']);
...
<div  id="inner_product"class="products_details">
    ...
    <div id="details_inner" class="inner_details">
        ...
        <a href="<?php echo $this->Html->url('/ProductDetails/addToCart/') . $id; ?>" class="cart">Add To Cart</a> 
