            ...
            <ul class="accordion"  id="accordion">
                ...
                <li><span class="drop"><img src="<?php echo $this->base; ?>/img/drop.png" width="7" height="16" alt="drop" /></span><a href="#">Category </a>
                    <ul>
                        <?php foreach ($categories as $cat_id => $category): ?>
                            ...
                            <li><?php echo $this->Html->link($category, array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'category', $cat_id)); ?>
                            <?php }endforeach; ?>
                    </ul>
                </li>
                <?php
                ...
                <li><span class="drop"><img src="<?php echo $this->base; ?>/img/drop.png" width="7" height="16" alt="drop" /></span><a href="#">Colors</a>
                    <ul>
                        <?php foreach ($colors as $color_id => $color): ?>
                            ...
                            <li><?php echo $this->Html->link($color, array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'color', $color_id)); ?>
                            <?php }endforeach; ?>
                    </ul>
                </li>
                <?php
                ...
                <li><span class="drop"><img src="<?php echo $this->base; ?>/img/drop.png" width="7" height="16" alt="drop" /></span><a href="#">Styles</a>
                    <ul>
                        <?php foreach ($styles as $style_id => $style): ?>
                            ...
                            <li><?php echo $this->Html->link($style, array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'style', $style_id)); ?>
                            <?php }endforeach; ?>
                    </ul>
                </li>
                <li><span class="drop"><img src="<?php echo $this->base; ?>/img/drop.png" width="7" height="16" alt="drop" /></span><a href="#">Prices</a>
                    <ul>
                        ...
                        <li><?php echo $this->Html->link('Less than £250',  array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'price', '1')); ?></li>
                        <li><?php echo $this->Html->link('£250 - £500', array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'price', '2')); ?></li>
                        <li><?php echo $this->Html->link('£500 - £1,000',  array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'price', '3')); ?></li>
                        <li><?php echo $this->Html->link('£1,000 - £2,000', array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'price', '4')); ?></li>
                        <li><?php echo $this->Html->link('£2,000 - £10,000',  array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'price', '5')); ?></li>
                        <li><?php echo $this->Html->link('More than £10,000',  array('plugin' => null, 'controller' => 'ProductDetails', 'action' => 'price', '6')); ?></li>
                    </ul>
                </li>
            </ul>
            <div class="clr"></div>
