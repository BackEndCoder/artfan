...
<div id="contact-container">
    ...
    <div id="contact-form">
        <div id="form-holder">
            ...
            echo $this->Form->input('Contactform.Name', array('label' => 'Name'));
            echo $this->Form->input('Contactform.Mail', array('label' => 'E-mail'));
            echo $this->Form->input('Contactform.Message', array('type' => 'textarea', 'label' => 'Message'));
            echo '<br />';
            echo $this->Form->submit('Submit', array('label' => 'submit'));
