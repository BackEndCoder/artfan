...
foreach (${$pluralVar} as ${$singularVar}):
	echo '<tr>';
		...
		echo '<td id="pop_menu" class="actions">';
		echo '<div class="popup_slider">';
		echo '<a class="popup-anc" href="" id="popup-anc">';
		echo'Action';
		echo'<i class="icon-arrow-down">';
		echo'</i>';
		echo'</a>';
		echo'<div class="row_fluid popup-menu" id="popup-anc">';
		echo '<ul>';

		echo'<li>';echo $this->Html->link(__d('cake', 'View'), array('action' => 'view', ${$singularVar}[$modelClass][$primaryKey]));echo'</li>';
		echo'<li>';echo ' ' . $this->Html->link(__d('cake', 'Edit'), array('action' => 'edit', ${$singularVar}[$modelClass][$primaryKey]));echo'</li>';
		echo'<li>';echo ' ' . $this->Form->postLink(
			__d('cake', 'Delete'),
