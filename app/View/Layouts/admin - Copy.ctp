...
<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <nav>
                <ul class="menu">
                    <li><a href="<?php echo $this->Html->url('/Admin'); ?>">Home </a></li>
                    <li><a href="<?php echo $this->Html->url('/Products'); ?>">Products </a></li>
                    <li><a href="<?php echo $this->Html->url('/Colors'); ?>">Colors </a></li>
                    <li><a href="<?php echo $this->Html->url('/Styles'); ?>">Styles </a></li>
                </ul>
                <div class="signup">
                    <ul>
                        <li><a href="<?php echo $this->Html->url('/'); ?>">View Site</a></li>                        
                        <li>
